...
if(box.isEmpty){
  await box.addAll([
    ...
    Location('القاهرة', 30.04, 31.235, 2.0),
    Location('طرابلس', 32.89, 13.19 , 2.0),
    Location('دمشق', 33.51, 36.291, 3.0),
    Location('London', 51.507, -0.128, 0.0),
    Location('New York', 40.7, -74.0, -4.0),
